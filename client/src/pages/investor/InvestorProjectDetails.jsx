          ...
          <div className="flex items-center gap-3">
            ...
            {userInterest?.status === "Pending" ? (
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#1F6F8B] px-4 py-2 text-xs font-bold text-white shadow-sm transition hover:bg-[#185a70]"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
              <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
                <Building2 size={18} className="text-[#1F6F8B]" />
                <h2 className="text-base font-bold text-[#172B3A]">
                  University & Faculty
                </h2>
              </div>
                ...
                <div className="mt-4 text-center py-4">
                  ...
                  {!userInterest && (
                    <button
                      type="button"
                      onClick={() => setShowModal(true)}
                      className="mt-3 inline-flex items-center gap-1.5 text-xs font-bold text-[#1F6F8B] hover:underline"
                    >
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
            <div className="w-full max-w-lg rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div className="flex items-center gap-2 text-[#172B3A]">
                  <Handshake size={20} className="text-[#1F6F8B]" />
              ...
              <form onSubmit={handleInterestSubmit} className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2 text-xs text-slate-800 focus:border-[#1F6F8B] focus:bg-white focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 p-3 text-xs text-slate-800 focus:border-[#1F6F8B] focus:bg-white focus:outline-none"
                  />
                ...
                <div className="mt-5 flex justify-end gap-3 border-t border-slate-100 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="inline-flex items-center gap-2 rounded-xl bg-[#172B3A] px-5 py-2 text-xs font-bold text-white shadow-md transition hover:bg-[#23445A] disabled:opacity-50"
                  >
                    {submitting ? (
                      <>
